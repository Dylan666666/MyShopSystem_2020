...
import com.oym.ssm.enums.LocalAuthStateEnum;
import com.oym.ssm.exceptions.LocalAuthOperationException;
import com.oym.ssm.service.LocalAuthService;
import com.oym.ssm.utils.CodeUtil;
import com.oym.ssm.utils.HttpServletRequestUtil;
...
//        PersonInfo user = (PersonInfo) request.getSession().getAttribute("user");
    ...
    private Map<String, Object> changeLocalPwd(HttpServletRequest request) {
        ...
        // TODO 从session中获取当前用户信息(用户一旦通过微信登录之后，便能获取到用户的信息)
        PersonInfo user = new PersonInfo();
        user.setUserId(1L);
