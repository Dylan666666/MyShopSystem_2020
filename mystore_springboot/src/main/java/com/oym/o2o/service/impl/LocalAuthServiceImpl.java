...
import com.oym.o2o.dao.LocalAuthDao;
...
import com.oym.o2o.service.LocalAuthService;
import com.oym.o2o.util.MD5;
...
public class LocalAuthServiceImpl implements LocalAuthService {
    ...
    public LocalAuthExecution bindLocalAuth(LocalAuth localAuth) throws LocalAuthOperationException {
        // 空值判断，传入的localAuth 帐号密码，用户信息不能为空，否则直接返回错误
        localAuth.getPersonInfo().setUserId(1L);
