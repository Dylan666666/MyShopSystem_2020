$(function() {
    // 获取该店铺下的奖品列表URL
    var listUrl = '/shopadmin/listawardsbyshop?pageIndex=1&pageSize=9999';
    // 设置奖品的可见状态
    var changeUrl = '/shopadmin/modifyaward';
    getList();
    ...
    $('.award-wrap').on('click', 'a', function(e) {
        ...
        if (target.hasClass('edit')) {
            ...
            window.location.href = '/shopadmin/awardoperation?awardId=' + e.currentTarget.dataset.id;
            ...
            window.location.href = '/frontend/awarddetail?awardId=' + e.currentTarget.dataset.id;
        }
    });
